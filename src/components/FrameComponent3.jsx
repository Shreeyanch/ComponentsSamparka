...
const FrameComponent3 = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-row items-center justify-center flex-wrap content-center text-center text-xs-4 text-black font-poppins ${className}`}
    >
      <div className="w-[270px] shadow-[0px_4px_12.2px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-white h-[175px] flex flex-col items-center justify-center py-2.5 px-0 box-border gap-2.5">
